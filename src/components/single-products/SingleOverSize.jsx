      ...
      <div className="flex flex-col lg:flex-row items-center gap-2 w-full px-4 my-4">
        ...
        <div className="flex flex-col justify-between w-full h-[33rem] rounded-2xl mb-8">
          ...
          <div className="flex flex-col gap-4 sm:px-7 pt-6">
            ...
            <p className="text-black/100 font-bold text-sm sm:text-base">
              {hoodiesSingleData.product_para}
            </p>

            <span className="text-green-700 font-bold text-2xl sm:text-3xl">
          ...
          <div className="flex flex-col sm:px-7 pt-4">
            <h1 className="text-black/100 font-bold text-lg sm:text-xl">
              Rate this Product
            </h1>
            ...
            <div className="my-4 flex gap-5">
              {[...Array(5)].map((_, index) => {
                ...
                return (
                  ...
                  >
                    {starValue <= rating ? (
                      <FaStar className="text-2xl sm:text-3xl text-yellow-400 cursor-pointer" />
                    ) : (
                      <FaRegStar className="text-2xl sm:text-3xl text-yellow-400 cursor-pointer" />
                    )}
                  </span>
                );
              })}
          ...
          <div className="flex flex-col sm:px-7 pt-4">
            <span className="flex items-center justify-between sm:justify-normal gap-[125px]">
              <span className="text-black/100 font-bold text-base sm:text-lg">
                Size : {selectedSize}
              </span>
            ...
            <div className="flex mt-5 gap-4 overflow-x-scroll hide-scrollbar">
              {["XS" , "S", "M"].map((size) => (
                <div
                  key={size}
                  className={`border rounded-lg py-1 px-3 cursor-pointer text-sm sm:text-base ${
                    selectedSize === size
                      ? "bg-black text-white"
                      : "border-black"
                  }`}
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:px-7 py-4">
            <button
              className="hover:scale-110 bg-green-800 hover:bg-green-600 text-white font-bold text-base sm:text-lg p-2 rounded-lg w-full"
            ...
            <button
              className="hover:scale-110 bg-black hover:bg-black/80 text-white font-bold text-base sm:text-lg p-2 rounded-lg w-full"
          ...
          <div className="text-center">
            <h1 className="text-sm sm:text-base">Please attach screen-shot of the product while checkout</h1>
          </div>
