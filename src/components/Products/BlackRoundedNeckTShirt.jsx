...
import printedOversized from "../../../json/BlackRoundedNeckTShirt.json";

const BlackRoundedNeckTShirt = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 p-2 sm:p-4 md:p-6 font-Amiri">
        {printedOversized.map((itmes, index) => (
...
export default BlackRoundedNeckTShirt;
